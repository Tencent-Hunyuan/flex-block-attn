...
# Package metadata
PACKAGE_NAME = "flex_block_attn"
VERSION = "0.1"
AUTHOR = "AngelPTM team"
DESCRIPTION = "AngelPTM Flex Block Attention Kernel"
URL = ""
...
print('ThunderKittens root:', tk_root)
...
setup(name=PACKAGE_NAME,
      ...
      ext_modules=[
          CUDAExtension('flex_block_attn_cuda',
